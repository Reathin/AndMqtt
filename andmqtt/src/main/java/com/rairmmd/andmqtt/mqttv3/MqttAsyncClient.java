...
package com.rairmmd.andmqtt.mqttv3;

import com.rairmmd.andmqtt.mqttv3.internal.ClientComms;
import com.rairmmd.andmqtt.mqttv3.internal.ConnectActionListener;
import com.rairmmd.andmqtt.mqttv3.internal.DisconnectedMessageBuffer;
import com.rairmmd.andmqtt.mqttv3.internal.ExceptionHelper;
import com.rairmmd.andmqtt.mqttv3.internal.NetworkModule;
import com.rairmmd.andmqtt.mqttv3.internal.SSLNetworkModule;
import com.rairmmd.andmqtt.mqttv3.internal.TCPNetworkModule;
import com.rairmmd.andmqtt.mqttv3.internal.security.SSLSocketFactoryFactory;
import com.rairmmd.andmqtt.mqttv3.internal.websocket.WebSocketNetworkModule;
import com.rairmmd.andmqtt.mqttv3.internal.websocket.WebSocketSecureNetworkModule;
import com.rairmmd.andmqtt.mqttv3.internal.wire.MqttDisconnect;
import com.rairmmd.andmqtt.mqttv3.internal.wire.MqttPublish;
import com.rairmmd.andmqtt.mqttv3.internal.wire.MqttSubscribe;
import com.rairmmd.andmqtt.mqttv3.internal.wire.MqttUnsubscribe;
import com.rairmmd.andmqtt.mqttv3.logging.Logger;
import com.rairmmd.andmqtt.mqttv3.logging.LoggerFactory;
import com.rairmmd.andmqtt.mqttv3.persist.MemoryPersistence;
import com.rairmmd.andmqtt.mqttv3.persist.MqttDefaultFilePersistence;
import com.rairmmd.andmqtt.mqttv3.util.Debug;
...
//				}
     ...
     * (non-Javadoc)
     *
     * @see IMqttAsyncClient#connect(java.lang.Object,
     * IMqttActionListener)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see IMqttAsyncClient#connect(MqttConnectOptions, java.lang.Object,
     * IMqttActionListener)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see IMqttAsyncClient#subscribe(java.lang.String, int, java.lang.Object,
     * IMqttActionListener)
     */
    @Override
    public IMqttToken subscribe(String topicFilter, int qos, Object userContext, IMqttActionListener callback,
