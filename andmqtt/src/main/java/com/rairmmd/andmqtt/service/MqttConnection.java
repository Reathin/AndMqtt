 ...
 */
package com.rairmmd.andmqtt.service;
...
import com.rairmmd.andmqtt.mqttv3.DisconnectedBufferOptions;
...
import com.rairmmd.andmqtt.mqttv3.MqttAsyncClient;
...
class MqttConnection implements MqttCallbackExtended {
    ...
    // from the mqttClient
    private HashMap<IMqttDeliveryToken, String> savedTopics = new HashMap<>();
    private HashMap<IMqttDeliveryToken, MqttMessage> savedSentMessages = new HashMap<>();
    private HashMap<IMqttDeliveryToken, String> savedActivityTokens = new HashMap<>();
    private HashMap<IMqttDeliveryToken, String> savedInvocationContexts = new HashMap<>();
